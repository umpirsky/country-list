...
INSERT INTO `country` (`id`, `name`) VALUES ('SS', 'Etelä-Sudan');
...
INSERT INTO `country` (`id`, `name`) VALUES ('BQ', 'Karibian Alankomaat');
...
INSERT INTO `country` (`id`, `name`) VALUES ('CC', 'Kookossaaret (Keelingsaaret)');
...
INSERT INTO `country` (`id`, `name`) VALUES ('PS', 'Palestiinalaisalueet');
...
INSERT INTO `country` (`id`, `name`) VALUES ('GB', 'Yhdistynyt kuningaskunta');
INSERT INTO `country` (`id`, `name`) VALUES ('US', 'Yhdysvallat');
INSERT INTO `country` (`id`, `name`) VALUES ('UM', 'Yhdysvaltain erillissaaret');
