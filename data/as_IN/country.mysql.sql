...
INSERT INTO `list` (`id`, `value`) VALUES ('AC', 'এচেনচিয়ন দ্বীপ');
...
INSERT INTO `list` (`id`, `value`) VALUES ('XK', 'কচ’ভ’');
...
INSERT INTO `list` (`id`, `value`) VALUES ('IC', 'কেনেৰী দ্বীপপুঞ্জ');
...
INSERT INTO `list` (`id`, `value`) VALUES ('EA', 'চেউটা আৰু মেলিলা');
...
INSERT INTO `list` (`id`, `value`) VALUES ('XA', 'ছুডু-একচেণ্ট');
INSERT INTO `list` (`id`, `value`) VALUES ('XB', 'ছুডু-বিডি');
...
INSERT INTO `list` (`id`, `value`) VALUES ('DG', 'ডিয়েগো গাৰ্চিয়া');
...
INSERT INTO `list` (`id`, `value`) VALUES ('TA', 'ত্ৰিস্তান দ্যা কুনহা');
...
INSERT INTO `list` (`id`, `value`) VALUES ('MO', 'মাকাউ এছ. এ. আৰ. চীন');
...
INSERT INTO `list` (`id`, `value`) VALUES ('MK', 'মেচিডোনীয়া');
